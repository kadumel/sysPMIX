...
from .views import (
    ...
    GestaoAlertasEcommerceView,
    AlertaEcommerceFormView,
    ...
    gestao_notificacao_analise_adicionar,
...
urlpatterns = [
    ...
    path(
        'alertas-ecommerce/',
        GestaoAlertasEcommerceView.as_view(),
        name='gestao_alertas_ecommerce',
    ),
    path(
        'alertas-ecommerce/novo/',
        AlertaEcommerceFormView.as_view(),
        name='gestao_alerta_novo',
    ),
    path(
        'alertas-ecommerce/<int:pk>/editar/',
        AlertaEcommerceFormView.as_view(),
        name='gestao_alerta_editar',
    ),
    path(
        'rotas-ecommerce/',
    ...
    path(
        'notificacoes-ecommerce/<int:pk>/analise/adicionar/',
        gestao_notificacao_analise_adicionar,
        name='gestao_notificacao_analise_adicionar',
    ),
    path(
